...
since = arrow.get('2022-06-05')
until = arrow.get('2022-06-06')
...
st.TweetSearchRunner(
    ...
    tweet_outputs=[st.CsvTweetOutput('1.csv'), st.PrintTweetOutput()],
...
tweet = downloader.fetch_media('https://twitter.com/i/status/1533500130145411073')
